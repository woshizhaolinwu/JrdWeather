...
public class JrdDialogHelper {
    private static final String PROGRESS_TAG = JrdDialogHelper.class.getSimpleName() + ":progress";
    private static final String TAG_HEAD = JrdDialogHelper.class.getSimpleName();

    /*加载中*/
    public static JrdCommonDialogFragment showProgress(android.app.FragmentManager fragmentManager, String message){
        return showProgress(fragmentManager, message, true, null);
    }

    public static JrdCommonDialogFragment showProgress(android.app.FragmentManager fragmentManager, String message, boolean cancelable){
        return showProgress(fragmentManager, message, cancelable, null);
    }

    public static JrdCommonDialogFragment showProgress(android.app.FragmentManager fragmentManager, final String message, boolean cancelable
            , JrdCommonDialogFragment.onCancelListener cancelListener){
            JrdCommonDialogFragment processDialog = JrdCommonDialogFragment.getInstance(new JrdCommonDialogFragment.onCallDialog() {
                @Override
        ...
        //processDialog.show(fragmentManager,"ProggressDialog");
        String TAG = "Progress Dialog";
        processDialog.show(fragmentManager, TAG_HEAD+"Progress");
    ...
    public static void showTips(android.app.FragmentManager fragmentManager, String message){
        showTips(fragmentManager, message, true, null);
    }

    public static void showTips(android.app.FragmentManager fragmentManager, String message, boolean cancelable){
        showTips(fragmentManager, message, cancelable, null);
    }

    public static void showTips(android.app.FragmentManager fragmentManager, final String message, boolean cancelable
            , JrdCommonDialogFragment.onCancelListener cancelListener){

        JrdCommonDialogFragment dialogFragment = JrdCommonDialogFragment.getInstance(new JrdCommonDialogFragment.onCallDialog() {
            @Override
            public Dialog getDialog(Context context) {
    ...
    public static void showConfirmDialog(android.app.FragmentManager fragmentManager, final String message, final IDialogResultListener<Integer> listener
            , boolean cancelable, JrdCommonDialogFragment.onCancelListener cancelListener){
        JrdCommonDialogFragment dialogFragment = JrdCommonDialogFragment.getInstance(new JrdCommonDialogFragment.onCallDialog() {
            @Override
            public Dialog getDialog(Context context) {
    ...
    public static DialogFragment showListDialog(android.app.FragmentManager fragmentManager, final String title, final String[] items
    ...
    public static DialogFragment showDateDialog(android.app.FragmentManager fragmentManager, final String title, final Calendar calendar
    ...
    public static void showTimeDialog(android.app.FragmentManager manager, final String title, final Calendar calendar, final IDialogResultListener<Calendar> resultListener, final boolean cancelable){
        JrdCommonDialogFragment dialogFragment = JrdCommonDialogFragment.getInstance(new JrdCommonDialogFragment.onCallDialog() {
            @Override
            public Dialog getDialog(Context context) {
                ...
                dateDialog.setOnShowListener(new DialogInterface.OnShowListener() {
                    @Override
                    public void onShow(DialogInterface dialog) {
                        dateDialog.getButton(DialogInterface.BUTTON_POSITIVE).setText("确定");
                        dateDialog.getButton(DialogInterface.BUTTON_NEGATIVE).setText("取消");
                    }
                });
    ...
    public static void showInsertDialog(android.app.FragmentManager manager, final String title, final IDialogResultListener<String> resultListener, final boolean cancelable){
    ...
    public static void showPasswordInsertDialog(android.app.FragmentManager manager, final String title, final IDialogResultListener<String> resultListener, final boolean cancelable){
        JrdCommonDialogFragment dialogFragment = JrdCommonDialogFragment.getInstance(new JrdCommonDialogFragment.onCallDialog() {
            @Override
            public Dialog getDialog(Context context) {
                final EditText editText = new EditText(context);
    ...
    public static void showIntervalInsertDialog(android.app.FragmentManager manager, final String title, final IDialogResultListener<String []> resultListener, final boolean cancelable){
        JrdCommonDialogFragment dialogFragment = JrdCommonDialogFragment.getInstance(new JrdCommonDialogFragment.onCallDialog() {
            @Override
            public Dialog getDialog(Context context) {
