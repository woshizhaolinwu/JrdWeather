...
public class JrdSubjectBean {
    private JrdSubjectBean.RatingBean rating;
    private String title;
    private int collect_count;
    private String original_title;
    private String subtype;
    private String year;
    private JrdSubjectBean.ImagesBean images;
    private String alt;
    private String id;
    ...
    public JrdSubjectBean.RatingBean getRating() {
        return rating;
    }

    public void setRating(JrdSubjectBean.RatingBean rating) {
        this.rating = rating;
    }
    ...
    public JrdSubjectBean.ImagesBean getImages() {
        return images;
    }

    public void setImages(JrdSubjectBean.ImagesBean images) {
        this.images = images;
    }
    ...
    public static class CastsBean {
        ...
        private String alt;
        private JrdSubjectBean.CastsBean.AvatarsBean avatars;
        private String name;
        private String id;
        ...
        public JrdSubjectBean.CastsBean.AvatarsBean getAvatars() {
            return avatars;
        }

        public void setAvatars(JrdSubjectBean.CastsBean.AvatarsBean avatars) {
    ...
    public static class DirectorsBean {
        ...
        private String alt;
        private JrdSubjectBean.DirectorsBean.AvatarsBeanX avatars;
        private String name;
        private String id;
        ...
        public JrdSubjectBean.DirectorsBean.AvatarsBeanX getAvatars() {
            return avatars;
        }

        public void setAvatars(JrdSubjectBean.DirectorsBean.AvatarsBeanX avatars) {
            this.avatars = avatars;
        }
